...
const ImageComponenDCT = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const UploadMessage = async () => {
      await fetch(baseUrl + "/uploadMessageDCT", {
        method: "POST",
        headers: {
  ...
  const handleSubmitDecode = (e) => {
    ...
    const DecodeFile = async () => {
      await fetch(baseUrl + "/uploadDecodeDCT", {
        method: "POST",
        body: formData,
      }).then((resp) => {
        resp.json().then((data) => {
...
export default ImageComponenDCT;