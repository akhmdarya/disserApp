...
const ImageComponentGauss = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const UploadFile = async () => {
            await fetch(baseUrl + "/uploadGauss", {
                method: "POST",
                body: formData,
            }).then((resp) => {
                resp.json().then((data) => {
        ...
        const UploadMessage = async () => {
            await fetch(baseUrl + "/uploadMessageGauss", {
                method: "POST",
                headers: {
    ...
    const handleSubmitDecode = (e) => {
        ...
        const DecodeFile = async () => {
            await fetch(baseUrl + "/uploadDecodeGauss", {
                method: "POST",
                body: formData,
            }).then((resp) => {
                resp.json().then((data) => {
...
export default ImageComponentGauss;