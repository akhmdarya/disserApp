...
const ImageComponentModifiedLSB = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const UploadFile = async () => {
            await fetch(baseUrl + "/uploadModM", {
                method: "POST",
                body: formData,
            }).then((resp) => {
                resp.json().then((data) => {
        ...
        const UploadMessage = async () => {
            await fetch(baseUrl + "/uploadMessageModM", {
                method: "POST",
                headers: {
    ...
    const handleSubmitDecode = (e) => {
        ...
        const DecodeFile = async () => {
            await fetch(baseUrl + "/uploadDecodeModM", {
                method: "POST",
                body: formData,
            }).then((resp) => {
                resp.json().then((data) => {
...
export default ImageComponentModifiedLSB;