...
const ImageComponentMedian = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const UploadFile = async () => {
            await fetch(baseUrl + "/uploadMedian", {
                method: "POST",
                body: formData,
            }).then((resp) => {
                resp.json().then((data) => {
        ...
        const UploadMessage = async () => {
            await fetch(baseUrl + "/uploadMessageMedian", {
                method: "POST",
                headers: {
    ...
    const handleSubmitDecode = (e) => {
        ...
        const DecodeFile = async () => {
            await fetch(baseUrl + "/uploadDecodeMedian", {
                method: "POST",
                body: formData,
            }).then((resp) => {
                resp.json().then((data) => {
...
export default ImageComponentMedian;